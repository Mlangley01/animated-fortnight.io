...
def door():           
    ...
    while True:        
        answer = (input())
        answer = answer.lower()
        if answer == "open" or answer=="o":
            note()
            break
        
        elif "dont" in answer or answer == "dont open" or answer == "d":
