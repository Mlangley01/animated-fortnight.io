...
def note():
        print_slow(r""""You turn the latch to the door and pull it open. poilce
        There's nobody there, just a cardboard box on your doorstep.
        That's weird, you could've sworn the knocking stopped right as you turned the latch- You take a closer look at the box.
        It has a label that has {name} OPEN IN PRIVATE! in big red letters tied to it.
        You know you should be suspicious of a strange parcel dropped on your doorstep,
        But there's a niggling feeling in the back of your mind that makes your curiosity take over.""")
