...
def game():
    ...
    while True:        
        ...
        if "yes" in answer or answer == "y":
            ...
            print_slow("That is not a valid response, try again\n")  
...
def phone():
        ...
        while True:        
            answer = (input())
            answer = answer.lower()
            if "answer" in answer or "pick up" in answer or answer == "a":
                door()
                break
                ...
                print_slow("That's not a valid response, try again\n")
...
You know deep down that this is all very suspicious, any sensible person would call the police. But....\n""")
    while True:
        ...
        answer = answer.lower()
        if "house" in answer or "go" in answer:
            kitchen()
            break
            ...
            print_slow("This is not a valid response, try again\n")
